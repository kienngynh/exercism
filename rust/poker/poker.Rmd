...
knit: (
  function(inputFile, encoding) { 
    ...
    file_name <- format(paste(type_note,format(Sys.time(),"%Y%m%d%H%M%S"),sep=""))
    ...
    file.copy(inputFile, file.path(format(paste("/home/tulipbk/github/kienngynh/notebooks/",type_note,sep="")), basename(format(paste(file_name,".Rmd",sep="")))))})
